...
import {pacote} from "./pacote";
 ...
 const jsonBruto = '{" id_voo ": "DRN -7742" , " data_envio ": "2026 -04 -28" , " detalhes ": { "": 120 , " sensores ": [" GPS " , " Termometro " , " Lidar "] } , " pacotes ": [ {"peso ": 1.2 , " descricao ": " Medicamentos "} , {" peso ": 0.8 , " descricao ": " Suprimentos "}] }';
